    ...
    <div className="flex flex-col h-screen bg-white relative font-sans text-gray-900">
      ...
      <div className="absolute bottom-0 w-full bg-white border-t border-gray-100 p-4 z-20 flex items-center justify-between gap-4 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
          <button 
            ...
            className="px-6 py-3 rounded-xl font-bold text-gray-500 bg-gray-50 hover:bg-gray-100 disabled:opacity-50 transition-colors"
          >
            Prev
          </button>
          ...
          <button 
            onClick={handleNext} 
            className="flex-1 py-3 rounded-xl font-bold text-white bg-brand-600 shadow-lg shadow-brand-200 hover:bg-brand-700 active:scale-[0.98] transition-all"
          >
