        ...
        {isOpen && (
            <>
                ...
                >
                    ...
                    <div className="px-5 pb-4 pt-safe-offset-14 bg-white/80 backdrop-blur-sm border-b border-gray-100 flex items-center gap-3 sticky top-0 z-30 shadow-sm shrink-0">
